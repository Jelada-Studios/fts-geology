package com.pandabear.geysers;

import com.pandabear.geysers.config.GeyserConfig;
import com.pandabear.geysers.registry.ModBlockEntities;
import com.pandabear.geysers.registry.ModBlocks;
import com.pandabear.geysers.registry.ModItems;
...
public class GeysersMod {
    ...
    public void onServerStopped(net.minecraftforge.event.server.ServerStoppedEvent event) {
        com.pandabear.geysers.tectonics.TectonicMap.clearCache();
        com.pandabear.geysers.tectonics.HotspotMap.clearCache();
        com.pandabear.geysers.volcano.VolcanoJob.clear();
        com.pandabear.geysers.quake.Weathering.clear();
        com.pandabear.geysers.quake.PendingEdits.clear();
    }
